...
%>
<% 	
	String merchant_key="lILOOGJZ";
	String salt="TVBR3aVI59";
	String action1 ="https://secure.payu.in/_payment";
	String base_url="https://sandboxsecure.payu.in";
	int error=0;
	String hashString="21Vay/Wc5TUBwwTpCX9m0Z/REiyvlrCY82HQPlvNQ1I=";
