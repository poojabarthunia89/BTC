...
public interface BTCeTradeService {
	...
	BTCResponse saveAdharNumber(String mobileNumber, String adharNumber);
	...
	public BitCoinRate getBitCoinRate(String network, String defaultCurrency,String curencyRateINR);

	public BTCResponse verifyEmailId(String phoneNumber, String emailId2);
